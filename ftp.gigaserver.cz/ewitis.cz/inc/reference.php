<style type="text/css">
    #references h3{font-size:150%;margin:0;padding:0;margin-bottom: 0.3em;}
    #references img{margin:0em;float:none;}
    #references p {margin:0em;}
    .reference{margin-bottom:2em;}
        .img_box_left{float:left; width:120px;}
        .img_box_left img,
        .img_box_right img{display:block; margin:0 auto !important;}
        .img_box_right{float:right;width:120px;}                        
